package Java_2.Lesson_5.HomeWork_5;
...
public class HomeWork_5 {
    ...
    public static void main(String[] args){
        HomeWork_5 mainClass = new HomeWork_5();
        mainClass.methodOne();
        mainClass.methodTwo();
    }
    ...
    private void methodOne(){
        ...
        System.out.println(String.format("Время выполнения метода %s", String.valueOf(end - start)));
    }
    ...
    private void methodTwo(){
        ...
        System.out.println(String.format("Время выполнения разделения массива %s", (split - start)));
    ...
    private void methodTwoInternal(float[] arr, int number){
        ...
        long end = System.currentTimeMillis();
        System.out.println(String.format("Время выполнения потока %d = %s", number, String.valueOf(end - start)));
    }
}